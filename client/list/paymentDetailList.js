...
Template.paymentDetailList.onRendered(function(){
	$('#tb_list').bootstrapTable({
		...
		columns: [
			...
			{field: 'zfbsc', title: '办事处', halign: 'center' },
            {field: 'zfrq', title: '支付日期', halign: 'center' },
            {field: 'fylb', title: '费用类别', halign: 'center' },
